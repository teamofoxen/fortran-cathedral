...
program forty
  ...
  use forty_inspect, only: run_inspect
  implicit none
  ...
  case (CMD_INSPECT);  call run_inspect(cli, code)
  case (CMD_GITHUB)
...
contains
  ...
  subroutine print_help()
    ...
    call say('  inspect [local|public]  UNROLL THE BROWSER TAPE MEASURE OVER EVERY PAGE.')
